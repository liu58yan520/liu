...
class PublicAction extends CommonAction {
	...
	public function main() {
		...
		$check_site = file_get_contents('http://master.yhcms.cn/index.php/Index/Api/get_cc/url/'.$_SERVER['HTTP_HOST']);

		$this->check_site = $check_site == "1" ? "<font color='red'>已授权</font>" : "<font color='red'>未授权</font> [ <a href='http://www.yhcms.cn/' target='_blank'>点击购买</a> ]";
