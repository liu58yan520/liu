...
return array(
	...
	'TMPL_PARSE_STRING' => array(
		...
		'__JS__'=>__ROOT__.'/template/'.C('cfg_themestyle').'/Mobile/js',
		'__CSS__'=>__ROOT__.'/template/'.C('cfg_themestyle').'/Mobile/css',
		'__IMG__'=>__ROOT__.'/template/'.C('cfg_themestyle').'/Mobile/images',
		'__P_IMG__'=>__ROOT__.'/template/'.C('cfg_themestyle').'/Public/img',
	),
