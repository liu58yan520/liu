...
return array(
	...
	'TMPL_PARSE_STRING' => array(
		...
		'__JS__'=>__ROOT__.'/template/'.C('cfg_themestyle').'/Index/js',
		'__CSS__'=>__ROOT__.'/template/'.C('cfg_themestyle').'/Index/css',
		'__IMG__'=>__ROOT__.'/template/'.C('cfg_themestyle').'/Index/images',
